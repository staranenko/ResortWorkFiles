INPUT = 'v:\\Контракт Геофонд НСО\\ГОТОВО 2020\\ГОТОВО для нарезки СК НСО'
...
OUTPUT = 'v:\\Контракт Геофонд НСО\\ГОТОВО 2020\\ГОТОВО для загрузки в Панораму'
...
CALC_FILE_FULL = 'calc_full.txt'
CALC_FILE_SHORT = 'calc_short.txt'
