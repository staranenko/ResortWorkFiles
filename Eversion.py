"""
Перекладывание рабочих файлов из структуры проктов в одну из двух стукрур:
    1. Сформировать рабочую структуру.
    2. Сохранить исходную структуру.
Работа управляетя параметрами командной строки.
"""
